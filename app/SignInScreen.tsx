...
// The Google sign-in landing. Rendered at /signin and reused as the guest
// home's empty state (a guest with no looked-at polls sees this directly,
// rather than a bespoke empty screen).
