...
Open `index.html`. A small dev-nav below the phone switches screens; on the Results screen a toggle flips between **Host view** (with "Finalize" buttons) and **Viewer**.
